...
// const transactionRepo = getRepository(Transactions, 'default'); // Use the correct connection name
...
export const getMyTokenSaleInfo = async function (req, res) {
